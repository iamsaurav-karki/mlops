'''
The MlFlow model Registry component is a centralized model store, set of APIs and UI, to collaboratively 
manage the full lifecycle of an MLflow Model. It provides model lineage (which run produced this model), 
...
with mlflow.start_run(run_name="Iris-Logistic-Regression-Run"):
    ...
    mlflow.set_tag("Training Info2", "Basic LR modle for Iris data ")
...
model_version = "latest"  # You can also specify a particular version number
